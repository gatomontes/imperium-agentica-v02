...
The occupant must carry the exact current Guildmaster Profile, pass qualification, be bound to Guildhall and this Seat, and have no conflicting occupancy.

## Authority while occupied

The Guildmaster may:

- convene the three admitted committee Seats
- verify exact, current, attributable contributions
