...
- accept or refuse a Foundry entry packet against its contract;
- establish and preserve the admitted profession queue and order;
- commission bounded work from Hagiography and Studium;
...
When vacant, Foundry retains its doctrine, artifacts, and ownership but cannot exercise cognitive judgment, authenticate candidates, approve production, or issue release packets.

Deterministic preservation and validation may continue only where already authorized and must not impersonate the Seat.
