...
Foundry is Imperium's Office for constructing deployment-medium-agnostic Personas from admitted professional, evidentiary, doctrinal, and operator-bound inputs.

Its resident Officer is the **Artificer**.
...
```text
Foundry Office ≠ Artificer Seat ≠ Artificer Profile ≠ Artificer Officer
```
