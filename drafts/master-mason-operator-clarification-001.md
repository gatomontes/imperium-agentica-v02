# Master Mason Operator Clarification 001
...
The clarified Master Mason is responsible for keeping Runtime operable through bounded diagnosis, maintenance, and recovery.
...
```text
Master Mason cognitively diagnoses and selects an eligible maintenance response.
...
The Master Mason may operate Runtime controls. It does not become Runtime itself.

## Naming Consequence

Use `Master Mason` for the candidate operator/mechanic responsibility.
