...
Subsequent review found that the expansion “Observer/Controller” invited an incorrect interpretation as two cooperating components, including a controller with execution influence. The designation is therefore defined as Observator/Custos (`OC`).
