...
Evaluate latent model capability independently from assigned mission authority and restrict unsuitable or excessively capable instruments.

## Risks Served

AIR-05, AIR-08–AIR-09, AIR-19–AIR-21, AIR-24

## Current Imperium Coverage

Imperium governs assigned roles and authority but has no admitted dangerous-capability evaluation.

## Required Behaviors

Capability profiles; dual-use classes; capability ceilings; mission matching; update-triggered reevaluation.
...
No model, provider, evaluator, threshold, or owner is selected.
...
- 2026-07-23 — RA Integration Review 001 linked `CTRL-004` as the smallest current pending control.
