...
| DR-003 | Select an OpenBao-hosted Imperium Service Port | Superseded as active B2.3 path by DR-004 |
| DR-004 | Select a local environment nonproduction secret bridge | Recorded decision candidate; merge gated |
