...
export const ISOLDE_DECISION_REF = "DR-089";
export const ISOLDE_EFFECTIVE_AT = "2026-08-03T02:00:00.000Z";
...
}, "isolde-officer-002", { identityFactory: (p) => p + "-isolde-v2", now: () => ISOLDE_EFFECTIVE_AT });

export const ISOLDE_ADMISSION_DECISION = createArtifact<OfficerPersonaAdmissionDecision>("OfficerPersonaAdmissionDecision", "Imperator", ISOLDE_CANDIDATE.correlationId, { candidateRef: ISOLDE_CANDIDATE.identity + "@1", officeProfileRef: ISOLDE_CANDIDATE.payload.officeProfileRef, authorityRef: ISOLDE_DECISION_REF + "#imperator-revalidation", authorityFindingRef: ISOLDE_DECISION_REF + "#authority-effective", conformanceEvidenceRefs: [evidenceRef], disposition: "ADMIT" }, [ISOLDE_CANDIDATE.identity + "@1", ISOLDE_CANDIDATE.payload.officeProfileRef, ISOLDE_DECISION_REF + "#imperator-revalidation", ISOLDE_DECISION_REF + "#authority-effective", evidenceRef], { identityFactory: (p) => p + "-isolde-v2", now: () => ISOLDE_EFFECTIVE_AT });
