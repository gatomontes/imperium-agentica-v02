...
export const ISOLDE_DECISION_REF = "DR-092";
export const ISOLDE_EFFECTIVE_AT = "2026-08-03T08:00:00.000Z";
...
}, "isolde-officer-003", { identityFactory: (p) => p + "-isolde-v3", now: () => ISOLDE_EFFECTIVE_AT });

export const ISOLDE_ADMISSION_DECISION = createArtifact<OfficerPersonaAdmissionDecision>("OfficerPersonaAdmissionDecision", "Imperator", ISOLDE_CANDIDATE.correlationId, { candidateRef: ISOLDE_CANDIDATE.identity + "@1", officeProfileRef: ISOLDE_CANDIDATE.payload.officeProfileRef, authorityRef: ISOLDE_DECISION_REF + "#imperator-correction", authorityFindingRef: ISOLDE_DECISION_REF + "#authority-effective", conformanceEvidenceRefs: [evidenceRef, reviewRef], disposition: "ADMIT" }, [ISOLDE_CANDIDATE.identity + "@1", ISOLDE_CANDIDATE.payload.officeProfileRef, ISOLDE_DECISION_REF + "#imperator-correction", ISOLDE_DECISION_REF + "#authority-effective", evidenceRef, reviewRef], { identityFactory: (p) => p + "-isolde-v3", now: () => ISOLDE_EFFECTIVE_AT });
