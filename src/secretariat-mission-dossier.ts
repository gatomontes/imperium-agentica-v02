...
export interface MissionIntentRequest { authenticatedOperatorRef: string; rawIntent: string; suppliedClaims?: string[]; assumptions?: string[]; authorityAssertions?: string[]; externalObligationAssertions?: string[]; attachmentRefs?: string[]; residentOfficerContractRef?: string; residentAgentDefinitionRef?: string; }
...
export interface IsoldeQuestionPresentation { dossierRef: string; inquiryRef: string; residentOfficerContractRef: string; questionId: string; exactQuestion: string; }
export interface IsoldeResponseReceipt { dossierRef: string; inquiryRef: string; residentOfficerContractRef: string; questionId: string; rawResponse: string; }
export interface IsoldeDispositionRelay { dossierRef: string; dispositionRef: string; residentOfficerContractRef: string; action: CastellanTurnAction; exactMessage: string; }
...
export interface MissionDossier {
  ...
  residentOfficerContractRef?: string; residentAgentDefinitionRef?: string; activeInquiryRef?: string; presentedQuestions: MissionInquiryQuestion[]; answers: RecordedAnswer[];
