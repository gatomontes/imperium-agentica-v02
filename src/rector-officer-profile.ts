...
export const RECTOR_DECISION_REF = "DR-091";
export const RECTOR_EFFECTIVE_AT = "2026-08-03T05:00:00.000Z";
...
}, "rector-officer-001", { identityFactory: (prefix) => prefix + "-rector", now: () => RECTOR_EFFECTIVE_AT });

export const RECTOR_ADMISSION_DECISION = createArtifact<OfficerPersonaAdmissionDecision>("OfficerPersonaAdmissionDecision", "Imperator", RECTOR_CANDIDATE.correlationId, { candidateRef: RECTOR_CANDIDATE.identity + "@1", officeProfileRef: RECTOR_CANDIDATE.payload.officeProfileRef, authorityRef: RECTOR_DECISION_REF + "#imperator-approval", authorityFindingRef: RECTOR_DECISION_REF + "#authority-effective", conformanceEvidenceRefs: [evidenceRef], disposition: "ADMIT" }, [RECTOR_CANDIDATE.identity + "@1", RECTOR_CANDIDATE.payload.officeProfileRef, RECTOR_DECISION_REF + "#imperator-approval", RECTOR_DECISION_REF + "#authority-effective", evidenceRef], { identityFactory: (prefix) => prefix + "-rector", now: () => RECTOR_EFFECTIVE_AT });
