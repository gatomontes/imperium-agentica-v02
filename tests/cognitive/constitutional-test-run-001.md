...
- `layers/cognitive/drafts/guildhall.md`
- `layers/cognitive/drafts/studium.md`
- `layers/cognitive/drafts/hagiography.md`
- `layers/cognitive/drafts/foundry.md`
- `layers/cognitive/drafts/pit.md`
- `layers/cognitive/drafts/garrison.md`
- `layers/cognitive/drafts/conscription.md`
- `layers/cognitive/drafts/catapult.md`
...
`layers/cognitive/drafts/cognitive-map.md` and substantial portions of `layers/cognitive/drafts/README.md` still encode the retired model:
...
1. `layers/cognitive/drafts/cognitive-map.md`
2. `layers/cognitive/drafts/README.md`
