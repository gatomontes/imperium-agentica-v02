...
## B2.3 Direct Security Export Retirement Candidate
...
- retired direct exports: 5
- historical source files deleted: 0
- historical test files deleted: 0
- replacement adapter implemented: no
- device selected: no
