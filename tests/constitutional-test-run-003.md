...
Run date: 2026-07-15
Previous run: tests/constitutional-test-run-002.md
Result: PASS
Passed: 12
Failed: 0
```
...
- `drafts2/README.md`
- `drafts2/lifecycle.md`
- `drafts2/production-artifacts.md`
- `drafts2/inquisition.md`
- `drafts2/armory-locksmith.md`
- `drafts2/theatre.md`
- `drafts2/constitutional-tests.md`

`drafts2/catapult.md` no longer exists.
