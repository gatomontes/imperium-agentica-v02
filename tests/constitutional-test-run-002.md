...
Run date: 2026-07-15
Previous run: tests/constitutional-test-run-001.md
Result: FAIL
Passed: 11
Failed: 1
```
...
However, `drafts2/castellan.md` still contains:
...
Replace “activated operative” in `drafts2/castellan.md` with “operative,” unless a distinct activation state is deliberately designed and admitted.
