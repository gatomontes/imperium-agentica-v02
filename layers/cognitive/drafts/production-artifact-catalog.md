...
| Artifact | Cognitive producer or steward | Canonical origin |
|---|---|---|
| Petition | Secretariat | `secretariat.md` |
| Mission Need | Castellan | `castellan.md` |
| Work Specification | Castellan | `castellan.md` |
| Profession Specification | Guildhall | `guildhall.md` |
| Persona Governance Doctrine | Studium | `studium.md` |
| Human-Trait Canon | Hagiography | `hagiography.md` |
| Persona Specification Candidate | Foundry | `foundry.md` |
| Pit Findings | Pit | `pit.md` |
| Garrison Record | Garrison | `garrison.md` |
| Operative | Conscription | `conscription.md` |
| Mission Inquest | Inquisition | `inquisition.md` |
| Mission Dossier | Muster | `muster.md` |
| Deployment Package | Muster | `muster.md` |
| Return Package | Lazaretto | `lazaretto.md` |
| Situation Picture | Chief of Staff | `chief-of-staff.md` |
| Curia Minute | Chief of Staff records; CEO owns decision | `curia.md`, `chief-of-staff.md`, `ceo-president.md` |
| Terminal Field Packet | Theatre | `theatre.md`; split closure contract |
| Mission Closure Record | CEO decision recorded by Curia | split closure contract |
...
| Structure | Canonical origin |
|---|---|
| Mission Correlation Spine | `layers/provenance/production/mission-correlation-and-isolation-contract.md` |
| Provider Intervention Ledger | `layers/provenance/production/provider-intervention-ledgers.md` |
| derivation, citation, supersession, and traceability relations | `layers/provenance/production/provenance-contract.md` |
