...
Candidate Cognitive role draft.

Not admitted, forged, assigned, authorized, or implemented.

Derived from Mason Operator Clarification 001.

## Purpose

Mason is the candidate operator and mechanic of the Runtime layer.
...
In architectural terms, Mason operates the control surface through which Runtime exposes admitted maintenance and recovery mechanisms.
...
- component health and availability observations
...
- credential-handling constraints from Locksmith when applicable
...
Mason may exercise bounded operational discretion only when:
...
- activate or deactivate a bounded component
- initiate a defined recovery
- restore a known operational state
- alter a resource limit within enumerated bounds
- clear a mechanically stalled condition without deleting semantic intent
- rotate or reload a credential binding with Locksmith constraints
- quarantine an unsafe attempt or component

The examples grant no authority and define no implementation.

## Structural-Change Boundary

Mason must stop and escalate when the proposed response would:

- deploy an unassessed implementation version
- alter semantic mappings
- migrate state across incompatible versions
- collapse distinct Procedure states
- erase lineage or historical addressability
- resolve an indeterminate external effect by assumption
...
Mason may identify `STRUCTURAL_CHANGE_REQUIRED`.

It does not decide the structural change merely because it found the need.

## Runtime Boundary

Mason owns diagnosis and bounded maintenance intent.
...
```text
Mason diagnosis ≠ Runtime state
Mason instruction ≠ effect performed
...
Mason acts only under an effective CONTROL_PLANE grant.
...
Mason does not invent a repair sequence.

If no admitted Procedure covers the diagnosed condition, Mason records the gap and withholds intervention except for an independently authorized safe state.

## Provenance Boundary

Every intervention preserves:

- Mason identity or acting-surface reference
...
- CEO mission decisions
- Chief of Staff Curia orchestration
- Muster mission assembly or binding release
- Armory tool provision
- Locksmith credential custody and access authority
- Runtime execution mechanics
- external operator authority over structural change

## Products

Candidate Cognitive products:
...
- Master Mason
- a Mason persona or Officer class
- Praetorium
- Compass
