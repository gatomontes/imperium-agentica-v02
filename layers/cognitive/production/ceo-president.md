...
Admitted standing Executive Officer role.
...
```text
CEO Standing Curia Role Requirement
→ Studium: Executive Officer Governance Doctrine
→ The Gesta: Executive Officer-Trait Canon
→ Smith: CEO Officer Specification Candidate
...
- rewrite doctrine, provider records, or mission purpose
