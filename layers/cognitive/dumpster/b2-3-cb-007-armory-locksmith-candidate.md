> Historical, non-authoritative material moved from the active Cognitive drafts surface during CB flattening.\n\n# Armory and Locksmith — CB-007 Sole-Accessor Candidate
...
Unadmitted CB-007 draft candidate derived from the admitted CB-006 `armory-locksmith.md`.
...
This Cognitive draft requires the observation but does not define ledger stages, lineage completeness, query semantics, corrections, or Provenance findings.
