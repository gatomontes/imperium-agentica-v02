...
Origin draft: `layers/procedure/drafts/mission-closure-and-release-procedure.md`.

## Native Dependencies

### Cognitive

- closure meanings and responsibilities: `layers/cognitive/production/mission-closure-and-release-contract.md`
