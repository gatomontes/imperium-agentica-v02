...
Origin draft: `layers/runtime/drafts/runtime-observation-envelope.md`.
...
This contract does not define a log service, event store, database schema, telemetry vendor, retention policy, cryptographic guarantee, mission-wide log, Codex, or Vellum.
