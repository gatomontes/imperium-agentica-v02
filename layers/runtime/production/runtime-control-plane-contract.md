...
Admitted Runtime production contract under Runtime Baseline `RTB-002`.
...
Origin draft: `layers/runtime/drafts/runtime-control-plane-contract.md`.
...
This contract selects no deployment platform, orchestration technology, database, secret manager, environment hierarchy, operator role, or live system.
