...
Derived from `drafts/authority-origin-investigation.md`.

Evidence so far: theoretical Authority Test Run A-001 — 7 PASS / 0 FAIL.

This contract does not grant authority by existing.
